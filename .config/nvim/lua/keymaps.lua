...
local map = utils.map
local nmap = function(...) utils.nmap(keymapper, ...) end
local nxmap = function(...) utils.nxmap(keymapper, ...) end
local nximap = function(...) utils.nximap(keymapper, ...) end
local cmd = utils.cmd
...
nxmap('<leader>gh', cmd('lua MiniGit.show_range_history()'), 'Show selection history')
